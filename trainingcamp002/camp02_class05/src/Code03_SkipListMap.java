...
/**
 * @author : WXY
 * @create : 2022-10-12 20:27
 * @Info : Code03_SkipListMap 跳表实现
 *
 */
public class Code03_SkipListMap {
    ...
    public static class SkipListMap<K extends Comparable<K>, V> {
        private static final double PROBAILITY = 0.5;
        ...
        public K lastKey() {
            ...
            SkipListNode<K, V> cur = head;
            while (levle >= 0) {
                SkipListNode<K, V> next = cur.nextNodes.get(levle);
                while (next != null) {
                    cur = next;
                    next = cur.nextNodes.get(levle);
                }
                levle--;
            }
            return cur.key;
