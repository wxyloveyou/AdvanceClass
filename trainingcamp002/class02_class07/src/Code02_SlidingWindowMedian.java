...
/**
 * @author : WXY
 * @create : 2022-10-27 18:36
 * @Info : Code02_SlidingWindowMedian
 */
public class Code02_SlidingWindowMedian {
    ...
    public static class SizeBalanceTreeMap<K extends Comparable<K>> {
        ...
        private SBTNode<K> getIndex(SBTNode<K> cur, int kth) {
            if (kth == (cur.l != null ? cur.l.size : 0)) {
                return cur;
    ...
    public static double[] medianSlidingWindow(int[] nums, int k) {
        SizeBalanceTreeMap<Node> map = new SizeBalanceTreeMap<>();
        for (int i = 0; i < k - 1; i++) {
